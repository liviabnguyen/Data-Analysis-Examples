...
base_name = "/rhome/lnguy091/bigdata/Project/Kmer-it/results/abund/part_"

content = []
LineNo = 0
start = 3 # first col w/ abundance estimates in kmer table
end = 21 # last col of kmer table
